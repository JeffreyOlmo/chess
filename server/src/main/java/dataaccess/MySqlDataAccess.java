...
public class MySqlDataAccess implements DataAccess {
    ...
    public AuthData writeAuth(String username) throws DataAccessException {
        ...
        executeUpdate("INSERT INTO `authentication` (authToken, username) VALUES (?, ?)", a.getAuthToken(), a.getUsername());
    ...
    private final String[] createStatements = {
            ...
            CREATE TABLE IF NOT EXISTS  game (
              ...
              `whitePlayerName` varchar(45) DEFAULT NULL,
              `blackPlayerName` varchar(45) DEFAULT NULL,
